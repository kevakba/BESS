...
df.to_csv(f'/home/kevin/Downloads/BESS/Jobs/Inferencing/data/raw/temperature_calgary_{str(start_date).split(" ")[0].replace("-", "")}_{str(end_date).split(" ")[0].replace("-", "")}.csv')